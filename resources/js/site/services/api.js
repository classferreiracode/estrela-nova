...
export function getMenu(location) {
    return api.get(`/menus/${location}`).then((r) => r.data)
}

export function getCtas() {
    return api.get('/ctas').then((r) => r.data)
}

export function subscribeNewsletter(email) {
    return api.post('/newsletter', { email }).then((r) => r.data)
}
