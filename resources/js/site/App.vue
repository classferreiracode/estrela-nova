    ...
    <div class="font-sans bg-stone-100 text-stone-700">
        ...
        <div class="fixed bottom-6 right-6 z-50">
            <a
                ...
                :target="floatingCta.open_in_new_tab ? '_blank' : undefined"
                :rel="floatingCta.open_in_new_tab ? 'noopener' : undefined"
            ...
            >
                <!-- <i class="father fa-whatsapp text-2xl"></i> -->
                <svg
...
import { ref } from 'vue'
import { getCtas } from '@/services/api'

const floatingCta = ref({
...
onMounted(async () => {
    try {
        ...
        floatingCta.value = ctas.find((cta) => cta.location === 'floating') || floatingCta.value
    } catch {
        // Mantém o contato aprovado caso a API esteja temporariamente indisponível.
    }
